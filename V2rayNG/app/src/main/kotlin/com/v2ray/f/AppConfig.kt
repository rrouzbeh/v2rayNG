 ...
 */
object AppConfig {
    const val ANG_PACKAGE = "com.v2ray.f"
    ...
    const val BROADCAST_ACTION_SERVICE = "com.v2ray.f.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.v2ray.f.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "com.v2ray.f.action.widget.click"
    ...
    const val v2rayNGIssues = "https://github.com/2dust/v2rayF/issues"
    const val v2rayNGWikiMode = "https://github.com/2dust/v2rayF/wiki/Mode"
